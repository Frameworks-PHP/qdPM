...
<div class="form-group">
	<label class="col-md-3 control-label" for="cfg_app_use_javascript_dropdown"><?php echo __('Use Javascript Dropdown'); ?></label>
  <div class="col-md-9">	
    <?php echo select_tag('cfg[app_use_javascript_dropdown]',sfConfig::get('app_use_javascript_dropdown'),array('choices'=>$default_selector),array('class'=>'form-control input-small')) ?>	  
  </div>			
</div>
