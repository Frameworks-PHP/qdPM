...
<?php echo '<table><tr><td>' . button_to(__('Backup'),'tools/doBackup',array('confirm'=>__('Are you sure?'),'class'=>'btn btn-primary')) . '</td><td style="padding-left: 15px;">' . ((count($backups)>sfConfig::get('app_rows_per_page'))? get_partial('global/jsPager', array('id'=>'pager')): '') . '</td></tr></table>' ?>
