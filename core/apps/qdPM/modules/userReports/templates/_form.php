        ...
        { 
          ...
          echo  '
            <div class="form-group">
            	...
            	<div class="col-md-9">          		
                ' . select_tag('user_reports[assigned_to]',explode(',',$v),array('choices'=>$choices,'multiple'=>true),array('class'=>'form-control','style'=>'height: 200px;')). '
            	</div>
            </div>
          ';         
        }                                      
        ...
        <?php
          ...
          { 
            ...
            <div class="form-group">
            	...
            	<div class="col-md-9">          		              
                ' . select_tag('user_reports[projects_id]',explode(',',$v),array('choices'=>$choices,'multiple'=>true),array('class'=>'form-control','style'=>'height: 200px;'))  . '
            	</div>
            </div>
          ';  
