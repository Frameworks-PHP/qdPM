...
<!-- BEGIN HEAD -->
  <head>
    ...
    <?php echo stylesheet_tag('/template/plugins/fullcalendar/fullcalendar/fullcalendar.css') ?>    
    ...
    <script>
      ...
      $(function(){
         ...
         //touchstart
         $('body').on('touchstart.yuimenubar', '.yuimenubaritemlevel0', function (e) {                   
            return false;
         });
  ...
  <body class="page-header-fixed yui-skin-sam <?php echo ($sf_request->getCookie('sidebar_closed','0')==1 ? 'page-sidebar-closed':''); ?>" id="yahoo-com">
    ...
    <div class="page-container">
      ...
      <div class="page-content-wrapper">
      	<div class="page-content-wrapper">
           ...
           <div id="ajax-modal" class="modal fade modal-scroll" tabindex="-1" data-replace="true" data-keyboard="false" data-backdrop="static" data-focus-on=".autofocus"></div>
...
<?php echo javascript_include_tag('/template/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js') ?>
...
jQuery(document).ready(function() {    
   ...
   <?php if($sf_context->getModuleName()=='scheduler') echo 'Calendar.init();'?>
