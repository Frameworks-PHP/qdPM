...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"> 
  <head> 
    ...
    <title>qdPM 9.0 BETA Installation</title> 
  ...
  <div id="page"> 
    ...
    <div id="header-wrap"> 
      <div id="header"> 
        <div id="logo-section">qdPM 9.0 BETA Installation</div>                  
      </div> 
    </div> 
  ...
  <div id="footer-wrap"> 
    ...
    <div id="footer"> 
      <div class="footer-text">       
        <br>
        qdPM 9.0 BETA | <a class="footer-text" target="_blank" href="http://qdpm.net/free-project-management-forum/index.php">Forum</a> | <a class="footer-text" target="_blank" href="http://qdpm.net/contact_us.php">Contacts</a>      <br>      
