...
function openModalBox(url)
{
  ...
  setTimeout(function(){
      ...
      if($('#ajax-modal textarea').hasClass('editor') || $('#ajax-modal textarea').hasClass('editor-auto-focus') 
          || url.search('users/new')>0 || url.search('users/eidt')>0 
          || url.search('tickets/new')>0 || url.search('tasks/new')>0 || url.search('discussions/new')>0
          || url.search('userReports/')>0
          )
